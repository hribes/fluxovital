...
def buscar_dados():
    load_dotenv()
    print("Tentando criar conexão...") # Debug: Adicionado
    ...
    if conexao is None:
        ...
        return None, None # Retorna None para ambos os dataframes
    ...
    # Se chegou aqui, a conexão é válida e está conectada
    print("Conexão bem-sucedida. Executando queries...")
    
    try: # É uma boa prática usar try...finally para garantir que a conexão feche
        ...
        if not caminho_do_arquivo_sql_2:
            ...
            return df_solicitacao_consulta, None # Retorna o que já tem
        ...
        # Dependendo do erro, você pode querer retornar None ou o que foi pego
...
# --- MODO CORRETO DE CHAMAR A FUNÇÃO ---
# 1. Chame a função e guarde os valores de retorno em variáveis
df_solicitacao, df_veiculo_retornado = buscar_dados()

# 2. Verifique se as variáveis não são None antes de usá-las
if df_solicitacao is not None:
    print("\n--- Resultados da Solicitação ---")
    print(df_solicitacao)
    print("Colunas:", df_solicitacao.columns)
else:
    print("\nNenhum dado de solicitação foi retornado.")

if df_veiculo_retornado is not None:
    print("\n--- Resultados do Veículo ---")
    print(df_veiculo_retornado)
    print("Colunas:", df_veiculo_retornado.columns)
else:
    print("\nNenhum dado de veículo foi retornado.")
    
    # print(buscar_dados())
    # print(df_solicitacao_consulta)
    # print(df_veiculo)
    # print(df_solicitacao_consulta.columns)